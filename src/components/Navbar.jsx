...
const Navbar = () => {
    ...
    return (
        <header className="w-full h-full text-white bg-black border-b-[var(--color-main)] border-b-2">
            <nav className="flex justify-between md:justify-around items-center p-5 ">
                ...
                <ul className="hidden md:flex lg:text-lg xl:text-xl  items-center gap-6 p-4 transition-all duration-300">
                    <li>Sobre mim</li>
                    <li>Tecnologias</li>
                    <li>Projetos</li>
                </ul>
            </nav>
            {isOpen && <ul className="flex flex-col items-center gap-4 p-4 transition-all duration-300">
                    <li>Sobre mim</li>
                    <li>Tecnologias</li>
                    <li>Projetos</li>
                </ul>}
